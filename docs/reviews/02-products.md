...
3. **Move them to a separate `/labs` or `/building` section** with a single-line explanation: *"Side projects I'm prototyping outside Simpaisa hours."*
...
- That is 11 categories in one line. Group them: *"Acceptance (cards, wallets, DCB, IBFT) · Cross-border + FX · Settlement · KYC/KYB · Fraud/AML."*
...
<meta name="description" content="Payment products built by Rizwan Zafar: Simpaisa payments infrastructure ($1B+ GTV, 5 markets), Tapmad wallet/billing migration (50%→1% cost), and projects in build.">
```
