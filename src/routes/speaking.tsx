...
const talks = [
  {
    ...
    abstract:
      "The unglamorous mechanics behind payment success in hard markets: authorization-rate optimisation, retry orchestration, bank-SLA management and routing across acquiring partners. How a platform holds payment success in hard markets at 90% straight-through processing, and what breaks when you try.",
  },
  {
    tag: "Product",
