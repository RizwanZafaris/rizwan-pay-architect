...
**What is the most common organisation-design mistake?** Hiring a PMO before the PgM layer is in place. The PMO standardises what the PgMs do; if there are no PgMs, there is nothing to standardise. The PMO becomes process for its own sake.`,"swift-compliance-checklist-for-banks-and-fintechs":`A working checklist of the SWIFT-related compliance items that auditors, bank sponsors, and regulators actually ask about. Treat this as a starting point, not a substitute for jurisdiction-specific advice.
