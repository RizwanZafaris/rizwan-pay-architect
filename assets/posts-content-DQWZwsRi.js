...
Related: [Reconciliation Is Product Infrastructure](/blog/reconciliation-is-product-infrastructure) · [Financial Controls Are Product Requirements](/blog/financial-controls-are-product-requirements)`,"click-to-pay-vctp-mctp-scheme-led-checkout":`Click to Pay is the schemes' answer to Apple Pay and Google Pay. It's a scheme-owned consumer checkout standard built on top of EMVCo's Secure Remote Commerce (SRC) specification, surfaced to consumers by Visa as **Visa Click to Pay (VCTP)** and by Mastercard as **Mastercard Click to Pay (MCTP)**.
...
Related: [Reconciliation Is Product Infrastructure](/blog/reconciliation-is-product-infrastructure) · [Exception Management](/blog/exception-management-reconciliation) · [Case study: Reconciliation & Ledger Controls](/product-work/settlement-reconciliation)`,"mdes-network-tokenisation-how-it-actually-works":`Network tokens are the most under-explained product in payments. They are the difference between a 60% authorisation rate and a 90% authorisation rate on stored cards. They are the reason Apple Pay actually works at scale. They are the migration most card-on-file businesses keep postponing and then regret.
