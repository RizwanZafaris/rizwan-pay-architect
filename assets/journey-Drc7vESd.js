...
`;function l({m:a}){return e.jsxs("article",{className:"journey-market-card rounded-2xl border border-rule bg-card p-6",children:[e.jsxs("div",{className:"flex items-center justify-between gap-3",children:[e.jsx("span",{className:"text-3xl leading-none","aria-hidden":"true",children:a.flag}),e.jsx("span",{className:"text-[10px] uppercase tracking-[0.18em] text-ink-soft font-mono-tech",children:a.years})]}),e.jsx("h3",{className:"mt-4 font-instrument text-2xl text-ink",children:a.name}),e.jsx("div",{className:"mt-1 text-[11px] uppercase tracking-[0.16em] text-[var(--brand)] font-mono-tech font-semibold",children:a.brand}),e.jsx("p",{className:"mt-4 text-sm leading-relaxed text-ink",children:a.shipped}),a.needsOwnerConfirm&&e.jsx("p",{className:"mt-3",children:e.jsx("span",{className:"journey-pending",children:"◇ Detail pending"})}),e.jsx("p",{className:"mt-4 border-t border-rule pt-4 text-sm italic leading-relaxed text-ink-soft",children:a.lesson})]})}function m(){return e.jsxs("div",{className:"journey-page",children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:o}}),e.jsxs("section",{className:"mx-auto max-w-6xl px-6 pt-20 pb-8 sm:pt-24",children:[e.jsx("div",{className:"journey-eyebrow text-[10px] uppercase tracking-[0.32em] text-[var(--brand)] font-mono-tech font-semibold",children:"◆ The operating map"}),e.jsx("h1",{className:"mt-8 font-instrument text-4xl leading-[1.05] text-ink sm:text-6xl",children:"Seventeen years. Ten markets. Three industries."}),e.jsx("p",{className:"mt-6 max-w-2xl text-lg leading-relaxed text-ink-soft",children:"I didn't study frontier markets — I shipped in them. This is the map: every market, what I built there, and what it taught me about payments, product and the distance between a regulation and a working checkout."})]}),e.jsxs("section",{className:"mx-auto max-w-6xl px-6 pb-16",children:[e.jsx("div",{className:"rounded-2xl border border-rule bg-surface p-4 sm:p-8",children:e.jsx(s,{showLabels:!0})}),e.jsx("p",{className:"mt-4 text-center text-[10px] uppercase tracking-[0.22em] text-ink-soft font-mono-tech",children:"◆ Ten operating markets · arcs originate from the Dubai hub"})]}),e.jsxs("section",{className:"mx-auto max-w-4xl px-6 py-8",children:[e.jsxs("div",{className:"mb-12 text-center",children:[e.jsx("div",{className:"text-[10px] uppercase tracking-[0.28em] text-[var(--brand)] font-mono-tech font-semibold",children:"◆ The arc"}),e.jsx("h2",{className:"mt-4 font-instrument text-3xl text-ink sm:text-4xl",children:"Three eras, one throughline"}),e.jsx("p",{className:"mx-auto mt-3 max-w-xl text-ink-soft",children:"Delivery discipline first, consumer scale next, then regulated payment infrastructure — each era compounding into the one after it."})]}),e.jsxs("div",{className:"journey-timeline",children:[e.jsx("div",{className:"journey-rail","aria-hidden":"true",children:e.jsx("div",{className:"journey-rail-beam"})}),e.jsx("ol",{className:"space-y-16 md:space-y-24",children:i.map(a=>e.jsxs("li",{className:"relative pl-8 md:pl-0",children:[e.jsx("span",{className:"journey-era-node","aria-hidden":"true"}),e.jsxs("div",{className:"md:mx-auto md:w-[46%] md:[&:nth-child(1)]:ml-auto",children:[e.jsxs("div",{className:"journey-era-label",children:[e.jsx("span",{className:"font-mono-tech text-[11px] uppercase tracking-[0.2em] text-[var(--brand)]",children:a.span}),e.jsx("span",{className:"font-instrument text-xl text-ink",children:a.title})]}),e.jsx("p",{className:"mt-5 text-base leading-relaxed text-ink",children:a.lede}),e.jsx("ul",{className:"mt-5 space-y-3",children:a.points.map(t=>e.jsx("li",{className:"journey-point text-sm leading-relaxed text-ink-soft",children:t},t))})]})]},a.id))})]})]}),e.jsxs("section",{className:"mx-auto max-w-6xl px-6 py-16",children:[e.jsxs("div",{className:"mb-10",children:[e.jsx("div",{className:"text-[10px] uppercase tracking-[0.28em] text-[var(--brand)] font-mono-tech font-semibold",children:"◆ Every stop on the map"}),e.jsx("h2",{className:"mt-4 font-instrument text-3xl text-ink sm:text-4xl",children:"Ten markets, ten lessons"}),e.jsx("p",{className:"mt-3 max-w-2xl text-ink-soft",children:"What shipped in each market — and the operating lesson it left behind."})]}),e.jsx("div",{className:"grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3",children:r.map(a=>e.jsx(l,{m:a},a.key))})]}),e.jsx("section",{className:"mx-auto max-w-6xl px-6 pb-24",children:e.jsxs("div",{className:"rounded-2xl border border-rule bg-surface-2 p-8 text-center sm:p-12",children:[e.jsx("h2",{className:"font-instrument text-2xl text-ink sm:text-3xl",children:"The map is the story. The work is the proof."}),e.jsx("p",{className:"mx-auto mt-3 max-w-xl text-ink-soft",children:"See the case studies behind these markets, or start a conversation about what comes next."}),e.jsxs("div",{className:"mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row",children:[e.jsx(n,{to:"/product-work",className:"inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-transform hover:-translate-y-0.5",children:"See the product work →"}),e.jsx("a",{href:"/contact/#book",className:"inline-flex items-center justify-center rounded-full border border-input px-6 py-3 text-sm font-semibold text-ink transition-colors hover:border-[color-mix(in_oklab,var(--signal)_40%,var(--rule))]",children:"Book a conversation"})]})]})})]})}export{m as component};
