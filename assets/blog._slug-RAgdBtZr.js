import{f,y as b,N as j,U as k,M as m,A as e,L as n,K as l,j as N,v as g,P as u,l as w,O as S}from"./index-BnW05qEA.js";import{p as T,D as L}from"./Diagrams-D24FA3eM.js";import{N as q}from"./NewsletterSignup-BNgxj2wi.js";function p(t){return t.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/(^-|-$)/g,"")}function h(t){return new Date(t).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}g.use({renderer:{checkbox({checked:t}){return`<input ${t?'checked="" ':""}disabled="" type="checkbox" aria-hidden="true" tabindex="-1"> `},heading({tokens:t,depth:a}){const s=this.parser.parseInline(t),r=p(t.map(o=>o.raw??"").join(""));return`<h${a} id="${r}"${a===2?' data-rz-reveal class="rz-section-head"':""}>${s}</h${a}>
`}}});function A(t){const a=g.parse(I(t),{async:!1});return e.jsx("div",{dangerouslySetInnerHTML:{__html:a}})}const C=new Set(m.map(t=>t.slug));function I(t){return t.replace(/\[([^\]]+)\]\(\/blog\/([^/#?)]+)\/?\)/g,(a,s,r)=>C.has(r)?a:s)}function _(t){return t.split(`
